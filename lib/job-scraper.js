         ...
         const aiResponse = await fetch("https://openrouter.ai/api/v1/chat/completions", {
            ...
            body: JSON.stringify({
              ...
              messages: [
                {
                  role: "system",
                  content: "You are an AI Career Agent. I will give you a user profile and a list of jobs. Rank them by fit, generate a precise match score (0-100), and write a 1-sentence personalized pitch why they fit. Output ONLY valid JSON containing an array of job objects. Do not use markdown blocks."
                },
                {
                  role: "user",
